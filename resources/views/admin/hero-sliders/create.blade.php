...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Add New Hero Slider</h2>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.hero-sliders.store') }}" method="POST" enctype="multipart/form-data" id="heroSliderForm">
            @csrf
           ...
           <div class="row">
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save me-2"></i>Create Hero Slider
                </button>
            </div>
        </form>
    </div>
...
<script>
    $(document).ready(function() {
        $('#heroSliderForm').validate({
            ...
            messages: {
                image: {
                    required: 'Please upload a slider image'
                },
                title: {
