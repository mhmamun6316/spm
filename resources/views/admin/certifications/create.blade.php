...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Add New Certification</h2>
        ...
        <form action="{{ route('admin.certifications.store') }}" method="POST" enctype="multipart/form-data" id="certificationForm">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="image" class="form-label">Certification Logo <span class="text-danger">*</span></label>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save me-2"></i>Create Certification
                </button>
            </div>
        </form>
    </div>
