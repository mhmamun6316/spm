...
@section('title', 'Add Satisfied Client')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Add New Satisfied Client</h2>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.satisfied-clients.store') }}" method="POST" enctype="multipart/form-data" id="clientForm">
            @csrf

            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="image" class="form-label">Client Logo <span class="text-danger">*</span></label>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save me-2"></i>Create Satisfied Client
                </button>
            </div>
        </form>
    </div>
