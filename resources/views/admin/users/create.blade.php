                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div id="profile_photo_preview" class="mt-2" style="display: none;">
                            <img id="profile_photo_img" src="" alt="Preview" class="img-fluid rounded border" style="max-height: 150px;">
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#userForm').validate({
            ...
            messages: {
                ...
                profile_photo: {
                    imageType: 'Please select a valid image file (JPEG, PNG, GIF, WebP)',
