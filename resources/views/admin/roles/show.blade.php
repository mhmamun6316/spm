...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">View Role: {{ $role->name }}</h2>
...
<div class="card">
    <div class="card-body">
        <div class="mb-4">
            <h5 class="fw-bold">Name: <span class="text-primary">{{ $role->name }}</span></h5>
            <p class="text-muted">Created At: {{ $role->created_at->format('M d, Y h:i A') }}</p>
        </div>
