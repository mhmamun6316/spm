...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Add New Board Member</h2>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.board-members.store') }}" method="POST" enctype="multipart/form-data" id="memberForm">
            @csrf
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save me-2"></i>Create Board Member
                </button>
            </div>
        </form>
    </div>
